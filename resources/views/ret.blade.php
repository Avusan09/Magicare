                                    ...
                                    <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="5caad2" style="margin-bottom:20px;">
                                        ...
                                        @if(count($varret) > 0)
                                            <tr>
                                                ...
                                                <th  style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">RET Renewed Date</th>
                                                <th  style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">RET Expiry Date</th>
                                            ...
                                            @foreach($varret as $rt)
                                                <tr>
                                                    ...
                                                    <th align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">{{$rt->ret_date}}</th>
                                                    <th align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">{{$rt->ret_expiry_date}}</th>
                                                </tr>
                                            @endforeach
                                        ...
                                        @else
                                            <p style="line-height: 24px;margin-bottom:15px;color: #c6c6c6">
                                                All vehicles's renewal permit are renewed.
                                            </p>
                                    @endif
