                                    ...
                                    <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="5caad2" style="margin-bottom:20px;">
                                        ...
                                        @if(count($varrp) > 0)
                                            <tr>
                                                ...
                                                <th  style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">RP Renewed Date</th>
                                                <th  style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">RP Expiry Date</th>
                                            ...
                                            @foreach($varrp as $rt)
                                                <tr>
                                                    ...
                                                    <th align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">{{$rt->rp_date}}</th>
                                                    <th align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">{{$rt->rp_expiry_date}}</th>
                                                </tr>
                                            @endforeach
